...
# Adapted from: https://github.com/rocker-org/rocker-versioned2/blob/master/scripts/userconf.sh
# I removed the chown parts because they took too long for large home folders
